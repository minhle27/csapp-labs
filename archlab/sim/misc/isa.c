...
struct
{
    char* name;
    int   id;
} reg_table[REG_ERR + 1] = { { "%rax", REG_RAX },  { "%rcx", REG_RCX }, { "%rdx", REG_RDX },
                             { "%rbx", REG_RBX },  { "%rsp", REG_RSP }, { "%rbp", REG_RBP },
                             { "%rsi", REG_RSI },  { "%rdi", REG_RDI }, { "%r8", REG_R8 },
                             { "%r9", REG_R9 },    { "%r10", REG_R10 }, { "%r11", REG_R11 },
...
char* cc_names[8] = { "Z=0 S=0 O=0", "Z=0 S=0 O=1", "Z=0 S=1 O=0", "Z=0 S=1 O=1",
                      "Z=1 S=0 O=0", "Z=1 S=0 O=1", "Z=1 S=1 O=0", "Z=1 S=1 O=1" };
...
stat_t step_state(state_ptr s, FILE* error_file)
{
    ...
    need_regids = (hi0 == I_RRMOVQ || hi0 == I_ALU || hi0 == I_PUSHQ || hi0 == I_POPQ ||
                   hi0 == I_IRMOVQ || hi0 == I_RMMOVQ || hi0 == I_MRMOVQ || hi0 == I_IADDQ);
    ...
    need_imm = (hi0 == I_IRMOVQ || hi0 == I_RMMOVQ || hi0 == I_MRMOVQ || hi0 == I_JMP ||
                hi0 == I_CALL || hi0 == I_IADDQ);
